...
#addPharmacistForm h2 {
    color: aqua;
}

#addPharmacistForm label {
    display: block;
    margin: 10px 0;
    color: aqua;
}
...
#addPharmacistForm input[type="button"] {
    background-color: aqua;
    color: black;
    border: none;
    padding: 10px 20px;
    ...
    <section class="main">
        <div class="sidebar">
            <ul class="sidebar--items">
                ...
                <li>
                    <a href="adminpharma.php" id="active--link">
            ...
            <h2 style="margin-left: 20px;margin-top:20px;">Pharmacy Management</h2>
            <input type="text" id="searchBar" oninput="searchPharmacists()" placeholder="Search for Pharmacist">
        </br>  
        </br>
...
if (isset($_POST['dname'])) {
    ...
    // Query to fetch pharmacists by name
    $sql = "SELECT * FROM pharmacistlogin WHERE name LIKE '%$searchDepartment%'";
} else {
    // Default query to fetch all pharmacists
    $sql = "SELECT * FROM pharmacistlogin";
}
...
<body>
        ...
        <tbody>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>Edit / Delete</td>";  // Add your edit/delete links or buttons here
                    echo "</tr>";
                }
            } else {
    ...
    <!-- Your existing scripts and other content here -->
...
<button onclick="openAddPharmacistForm()">Add Pharmacist</button>

<!-- Add Pharmacist Form (Initially hidden) -->
<div id="addPharmacistForm" style="display: none;">
    <h2>Add Pharmacist</h2>
    <form id="pharmacistForm">
        <label for="pharmacistName">Pharmacist Name:</label>
        <input type="text" id="pharmacistName" required><br>

        <label for="pharmacistPassword">User Password:</label>
        <input type="password" id="pharmacistPassword" required><br>

        <label for="pharmacistMail">Mail ID:</label>
        <input type="email" id="pharmacistMail" required><br>

        <input type="button" value="Submit" onclick="addPharmacist()">
    </form>
</div>
