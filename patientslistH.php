...
$query = "select * from healthcheckuppackages;";
...
if(isset($_POST['present'])){
  ...
  for($i=1;$i<25;$i++){
    $n="SELECT  `name` FROM `healthcheckuppackages` WHERE sno=$i;";
    $sql="UPDATE `healthcheckuppackages` SET `Availability`='$present' WHERE sno=$i;";
...
<body>
    ...
    <nav>
    <a href="doctordashboardH.php"><button class="submit-btn" id="mydashboardButton">My Dashboard </button></a>
       <a href="myappointmentsH.php"><button class="submit-btn" id="myappointmentsButton">My Appointments ></button></a>
