...
<body>
    <div class="container">
        ...
        <div class="options">
            <a href="patientslistC.php"><button class="button" id="doctorpageButton">Patients list</button></a>
            <a href="myappointmentsC.php"><button class="button" id="myappointmentsButton">My Appointments</button></a>
        </div>
    </div>
    <div class="logo-box">
    ...
    <script>
        ...
        doctorpageButton.addEventListener("click", function() {
            ...
            window.location.href = "patientslistC.php"; 
        });
