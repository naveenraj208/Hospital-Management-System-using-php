...
$query = "select * from dermatologyandcosmetology;";
...
if(isset($_POST['present'])){
  ...
  for($i=1;$i<25;$i++){
    $n="SELECT  `name` FROM `dermatologyandcosmetology` WHERE sno=$i;";
    $sql="UPDATE `dermatologyandcosmetology` SET `Availability`='$present' WHERE sno=$i;";
...
<body>
    ...
    <nav>
        <a href="doctordashboardD.php"><button class="submit-btn" id="mydashboardButton">My Dashboard </button></a>
       <a href="myappointmentsD.php"><button class="submit-btn" id="myappointmentsButton">My Appointments ></button></a>
