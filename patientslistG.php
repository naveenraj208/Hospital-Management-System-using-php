...
$query = "select * from generalsurgery;";
...
if(isset($_POST['present'])){
  ...
  for($i=1;$i<25;$i++){
    $n="SELECT  `name` FROM `generalsurgery` WHERE sno=$i;";
    $sql="UPDATE `generalsurgery` SET `Availability`='$present' WHERE sno=$i;";
...
<body>
    ...
    <nav>
    <a href="doctordashboardG.php"><button class="submit-btn" id="mydashboardButton">My Dashboard </button></a>
       <a href="myappointmentsG.php"><button class="submit-btn" id="myappointmentsButton">My Appointments ></button></a>
